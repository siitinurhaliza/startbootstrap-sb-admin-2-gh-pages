...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $query = "SELECT * FROM pengembalian WHERE nama LIKE '%$key%' OR judul LIKE '%$key%' OR tanggal LIKE '%$key%'";
    $datas = mysqli_query($koneksi, $query) or die(mysqli_error($koneksi));
} else {
    // If the form is not submitted, fetch all data
    $datas = mysqli_query($koneksi, "SELECT * FROM pengembalian") or die(mysqli_error($koneksi));
}
                ...
                <div class="card-body">
                    <form action="" method="post">
                        <div class="row mb-3">
                            ...
                            <a href="tambahpenerbit.php" class="btn btn-primary mb-4"><i class="bi bi-bookmark-plus-fill">TAMBAH DATA</i>
        ...
        // Redirect to the main page after deletion
                            ...
                            ?>
                                    <tr style="background-color: <?= $rowColor; ?>">
                                        ...
                                        <td><?= $row['status']; ?></td>
                                        <td>
                                            <a href="editpeminjaman.php?id=<?= $row['id']; ?>" class="btn btn-sm btn-warning">Edit</a>
