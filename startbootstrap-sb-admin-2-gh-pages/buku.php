...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
   ...
   // Ubah kueri SQL Anda untuk menyertakan kondisi pencarian
    $query = "SELECT * FROM buku WHERE foto LIKE '%$key%' OR  LIKE '%$key%' OR penerbit LIKE '%$key%' OR stok LIKE '%$key%' OR kategori LIKE '%$key%' OR rak LIKE '%$key%'";
                ...
                <div class="card-body">
                    <form action="" method="post">
                        <div class="row mb-3">
                            ...
                            <a href="tambahbuku.php" class="btn btn-primary mb-4"><i class="bi bi-bookmark-plus-fill">TAMBAH DATA</i>
...
// Redirect ke halaman utama setelah penghapusan
                            ...
                            ?>
                                    <tr style="background-color: <?= $rowColor; ?>">
                                        ...
                                        <td><?= $row['rak']; ?></td>
                                        <td>
                                            <a href="editbuku.php?id=<?= $row['id']; ?>" class="btn btn-sm btn-warning">Edit</a>
