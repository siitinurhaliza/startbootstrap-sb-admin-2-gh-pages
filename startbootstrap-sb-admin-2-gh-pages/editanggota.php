...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // Update data anggota
    $query = "UPDATE anggota SET poto=?, nisn=?, nama=?, kelas=?, jk=?, alamat=? WHERE id=?";
    $stmt = mysqli_prepare($koneksi, $query);

    if ($stmt) {
        mysqli_stmt_bind_param($stmt, "sssssis", $poto, $nisn, $nama, $kelas, $jk, $alamat, $id);
...
if (isset($_GET['id'])) {
    ...
    if ($stmt) {
        ...
        mysqli_stmt_bind_result($stmt, $id, $poto, $nisn, $nama, $kelas, $jk, $alamat);
            ...
            <div id="content">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <label for="poto" class="fw-bold">Gambar</label>
                            <input type="file" name="poto"  class="form-control" value="<?php echo isset($poto) ? $poto : ''; ?>">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="kelas" class="form-control" value="<?php echo isset($kelas) ? $kelas : ''; ?>">
                            </div>
                            <div class="form-group">
                                <label for="jk">Jenis Kelamin</label>
                                <input type="text" name="jk" class="form-control" value="<?php echo isset($jk) ? $jk : ''; ?>">
                            </div>
                            <div class="form-group">
                                <label for="alamat">Alamat</label>
                                <input type="text" name="alamat" class="form-control" value="<?php echo isset($alamat) ? $alamat : ''; ?>">
                            </div>
                            <!-- Menambahkan input hidden untuk menyimpan ID rak yang akan diubah -->
                            <input type="hidden" name="id" value="<?php echo isset($id) ? $id : ''; ?>">
                            
                            <button type="submit" class="btn btn-primary" name="simpan">Simpan</button>
                            <a href="rak.php" class="btn btn-danger">Batal</a>
                        </form>
                    </div>
                </div>
            </div>
