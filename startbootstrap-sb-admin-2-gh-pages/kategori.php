...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $query = "SELECT * FROM kategori WHERE nama LIKE '%$key%' OR keterangan LIKE '%$key%'";
    $datas = mysqli_query($koneksi, $query) or die(mysqli_error($koneksi));
} else {
    // If the form is not submitted, fetch all data
    $datas = mysqli_query($koneksi, "SELECT * FROM kategori") or die(mysqli_error($koneksi));
}
                ...
                <div class="card-body">
                    <form action="" method="post">
                        <div class="row mb-3">
                            ...
                            <a href="tambahkategori.php" class="btn btn-primary mb-4"><i class="bi bi-bookmark-plus-fill">TAMBAH DATA</i>
