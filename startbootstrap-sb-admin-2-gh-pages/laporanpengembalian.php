...
<?php
$Sql = "SELECT A.*, B.nama FROM laporankembali A JOIN member B ON A.kdmember = B.kdmember $SqlPeriode";
...
while ($myData = mysqli_fetch_array($myQry)) {
    ...
    <tr>
        ...
        <td><?php echo $myData['tanggalpinjam']; ?></td>
        <td><?php echo $myData['tanggalkembali']; ?></td>
...
<div class="row">
    <div class="col-lg-3">
        <a href="cetak.php?awal=<?php echo $tglAwal; ?>&&akhir=<?php echo $tglAkhir; ?>" target="_blank"
            alt="Edit Data" class="btn btn-primary">Cetak Laporan</a>
    </div>
</div>
