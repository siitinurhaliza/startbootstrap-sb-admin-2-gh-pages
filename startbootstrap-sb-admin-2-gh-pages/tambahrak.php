...
if(isset($_POST['proses'])){
    mysqli_query($koneksi,"insert into rak set
    nomor = '$_POST[nomor]',
    nama = '$_POST[nama]',
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table table-bordered">
                                <tbody>
                        <div class="mb-3">
                            <label for="nomor" class="form-label fw-bold">Nomor Rak</label>
                            <input type="text" class="form-control" name="nomor" id="nomor">
                        </div>
                    </div>
                        <div class="mb-3">
                            <label for="nama" class="form-label fw-bold">Nama Rak</label>
