...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // Update data rak
    $query = "UPDATE rak SET nomor=?, nama=?, keterangan=? WHERE id=?";
    $stmt = mysqli_prepare($koneksi, $query);
    
    if ($stmt) {
        mysqli_stmt_bind_param($stmt, "sssi", $nomor, $nama, $keterangan, $id);
...
// Ambil data rak yang akan di-edit
if (isset($_GET['id'])) {
    $id_to_edit = $_GET['id'];
    $query = "SELECT * FROM rak WHERE id=?";
    $stmt = mysqli_prepare($koneksi, $query);

    if ($stmt) {
        mysqli_stmt_bind_param($stmt, "i", $id_to_edit);
        mysqli_stmt_execute($stmt);
        mysqli_stmt_bind_result($stmt, $id, $nomor, $nama, $keterangan);
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                                <label for="nomor">Nomor Rak</label>
                                <input type="text" name="nomor" class="form-control" value="<?php echo isset($nomor) ? $nomor : ''; ?>">
                            </div>
                            <div class="form-group">
