...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $query = "SELECT * FROM penerbit WHERE nama LIKE '%$key%' OR keterangan LIKE '%$key%'";
    $datas = mysqli_query($koneksi, $query) or die(mysqli_error($koneksi));
} else {
    // If the form is not submitted, fetch all data
    $datas = mysqli_query($koneksi, "SELECT * FROM penerbit") or die(mysqli_error($koneksi));
}
        ...
        // Redirect to the main page after deletion
                            ...
                            ?>
                                    <tr style="background-color: <?= $rowColor; ?>">
                                        ...
                                        <td>
                                            <a href="editpenerbit.php?id=<?= $row['id']; ?>" class="btn btn-sm btn-warning">Edit</a>
