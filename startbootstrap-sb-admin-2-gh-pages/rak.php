...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $query = "SELECT * FROM rak WHERE nomor LIKE '%$key%' OR nama LIKE '%$key%' OR keterangan LIKE '%$key%'";
    $datas = mysqli_query($koneksi, $query) or die(mysqli_error($koneksi));
} else {
    // If the form is not submitted, fetch all data
    $datas = mysqli_query($koneksi, "SELECT * FROM rak") or die(mysqli_error($koneksi));
}
...
<div class="container-fluid">
                ...
                <div class="card-body">
                    <form action="" method="post">
                        <div class="row mb-3">
                            ...
                            <a href="tambahrak.php" class="btn btn-primary mb-4"><i class="bi bi-bookmark-plus-fill">TAMBAH DATA</i>
    ...
    if (isset($_GET['id'])) {
        ...
        $query = "DELETE FROM rak WHERE id = ?";
        ...
        // Redirect to the main page after deletion
                            ...
                            ?>
                                    <tr style="background-color: <?= $rowColor; ?>">
                                        ...
                                        <td>
                                            <a href="editrak.php?id=<?= $row['id']; ?>" class="btn btn-sm btn-warning">Edit</a>
