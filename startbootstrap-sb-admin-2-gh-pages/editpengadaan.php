...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $query = "UPDATE pengadaan SET tanggal=?, judul=?, asal=?, jumlah=?, keterangan=? WHERE id=?";
    $stmt = mysqli_prepare($koneksi, $query);

    if ($stmt) {
        mysqli_stmt_bind_param($stmt, "sssssi", $tanggal, $judul, $asal, $jumlah, $keterangan, $id);
        ...
        if ($updateResult) {
            ...
            exit(); // Hentikan eksekusi skrip setelah mengarahkan ke halaman lain
        } else {
...
// Ambil data pengadaan yang akan di-edit
if (isset($_GET['id'])) {
    $id_to_edit = $_GET['id'];
    $query = "SELECT * FROM pengadaan WHERE id=?";
    $stmt = mysqli_prepare($koneksi, $query);

    if ($stmt) {
        mysqli_stmt_bind_param($stmt, "i", $id_to_edit);
        mysqli_stmt_execute($stmt);
        mysqli_stmt_bind_result($stmt, $id, $tanggal, $judul, $asal, $jumlah, $keterangan);
                    ...
                    <div class="card-body">
                        ...
                        <form action="" method="POST" class="form-item">
                            <div class="form-group">
                                ...
                                <input type="text" name="tanggal" class="form-control" value="<?php echo isset($tanggal) ? $tanggal : ''; ?>">
                            </div>
                            <div class="form-group">
                                <label for="judul">Judul</label>
                                <input type="text" name="judul" class="form-control" value="<?php echo isset($judul) ? $judul : ''; ?>">
                            </div>
                            <div class="form-group">
                                <label for="asal">Asal Buku</label>
                                <input type="text" name="asal" class="form-control" value="<?php echo isset($asal) ? $asal : ''; ?>">
                            </div>
                            <div class="form-group">
                                <label for="jumlah">Jumlah</label>
                                <input type="text" name="jumlah" class="form-control" value="<?php echo isset($jumlah) ? $jumlah : ''; ?>">
                            </div>
                            <div class="form-group">
                                <label for="keterangan">Keterangan</label>
                                <input type="text" name="keterangan" class="form-control" value="<?php echo isset($keterangan) ? $keterangan : ''; ?>">
                            </div>
                            <!-- Menambahkan input hidden untuk menyimpan ID penerbit yang akan diubah -->
                            <input type="hidden" name="id" value="<?php echo isset($id) ? $id : ''; ?>">
                            
                            <button type="submit" class="btn btn-primary" name="simpan">Simpan</button>
                            <a href="penerbit.php" class="btn btn-danger">Batal</a>
                        </form>
                    </div>
                </div>
            </div>
