...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // Update data anggota
    $query = "UPDATE buku SET foto=?, judul=?, penerbit=?, stok=?, kategori=?, rak=? WHERE id=?";
    $stmt = mysqli_prepare($koneksi, $query);

    if ($stmt) {
        mysqli_stmt_bind_param($stmt, "sssssis", $foto, $judul, $penerbit, $stok, $kategori, $rak, $id);
...
if (isset($_GET['id'])) {
    ...
    if ($stmt) {
        ...
        mysqli_stmt_bind_result($stmt, $id, $foto, $judul, $penerbit, $stok, $kategori, $rak);
                    ...
                    <div class="card-body">
                        ...
                        <label for="foto" class="fw-bold">Gambar</label>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="penerbit" class="form-control" value="<?php echo isset($penerbit) ? $penerbit : ''; ?>">
                            </div>
                            <div class="form-group">
                                <label for="stok">Stok</label>
                                <input type="text" name="stok" class="form-control" value="<?php echo isset($stok) ? $stok : ''; ?>">
                            </div>
                            <div class="form-group">
                                <label for="kategori">Kategori</label>
                                <input type="text" name="kategori" class="form-control" value="<?php echo isset($kategori) ? $kategori : ''; ?>">
                            </div>
                            <div class="form-group">
                                <label for="rak">Rak</label>
                                <input type="text" name="rak" class="form-control" value="<?php echo isset($rak) ? $rak : ''; ?>">
                            </div>
