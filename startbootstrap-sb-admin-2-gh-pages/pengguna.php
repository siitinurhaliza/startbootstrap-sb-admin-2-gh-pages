...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
   ...
   // Ubah kueri SQL Anda untuk menyertakan kondisi pencarian
    $query = "SELECT * FROM pengguna1 WHERE foto LIKE '%$key%' OR nama LIKE '%$key%' OR email LIKE '%$key%' OR status LIKE '%$key%' OR level LIKE '%$key%' OR tlp LIKE '%$key%' ";
    $datas = mysqli_query($koneksi, $query) or die(mysqli_error($koneksi));
} else {
    // Jika formulir tidak dikirimkan, ambil semua data
    $datas = mysqli_query($koneksi, "SELECT * FROM pengguna1") or die(mysqli_error($koneksi));
}
...
<div class="container-fluid">
                ...
                <div class="card-body">
                    <form action="" method="post">
                        <div class="row mb-3">
                            ...
                            <a href="tambahpengguna.php" class="btn btn-primary mb-4"><i class="bi bi-bookmark-plus-fill">TAMBAH DATA</i>
   ...
   // Hapus data dari database
        $query = "DELETE FROM pengguna1 WHERE id = ?";
...
// Redirect ke halaman utama setelah penghapusan
                            ...
                            ?>
                                    <tr style="background-color: <?= $rowColor; ?>">
                                        ...
                                        <td>
                                            <a href="editpengguna.php?id=<?= $row['id']; ?>" class="btn btn-sm btn-warning">Edit</a>
